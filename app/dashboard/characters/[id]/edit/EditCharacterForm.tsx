// arin/app/dashboard/characters/[id]/edit/EditCharacterForm.tsx
'use client'
...
export default function EditCharacterForm({
  ...
  const [form, setForm] = useState({
    ...
    lore:          initialCharacter.lore ?? '',
    ref_sheet_url: initialCharacter.ref_sheet_url ?? '',
    tags:          initialCharacter.tags?.join(', ') ?? '',
    is_public:     initialCharacter.is_public ?? true,
  })
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    const result = await updateCharacter(characterId, form)
